...
//here we're just breaking the para into spand of each word
var clutter = "";
document.querySelector('#page2>h1').textContent.split("").forEach((dets)=>{
  if(dets != " "){clutter += `<div style = "display:inline-block"> ${dets} </div>`} //if i don't do this then all these divs get weird spacing between them
else{clutter += `<div style="display:inline"> ${dets} </div>`}

})
document.querySelector("#page2>h1").innerHTML = clutter;


gsap.to("#page2>h1>div",{
  scrollTrigger:{
    trigger:"#page2>h1>div",
    start: "top bottom",
    end: "bottom 70%",
    scrub: 2
  },
...
document.querySelector('#page4>h1').textContent.split("").forEach((dets)=>{
  if(dets != " "){clutter2 += `<div style = "display:inline-block"> ${dets} </div>`} //if i don't do this then all these divs get weird spacing between them
else{clutter2 += `<div style="display:inline"> ${dets} </div>`}

})
document.querySelector("#page4>h1").innerHTML = clutter2;


gsap.to("#page4>h1>div",{
  scrollTrigger:{
    trigger:"#page4>h1>div",
    start: "top 90%",
    end: "bottom 70%",
    scrub: 2
  },
...
document.querySelector('#page6>h1').textContent.split("").forEach((dets)=>{
  if(dets != " "){clutter3 += `<div style = "display:inline-block"> ${dets} </div>`} //if i don't do this then all these divs get weird spacing between them
else{clutter3 += `<div style="display:inline"> ${dets} </div>`}

})
document.querySelector("#page6>h1").innerHTML = clutter3;


gsap.to("#page6>h1>div",{
  scrollTrigger:{
    trigger:"#page6>h1>div",
    start: "top 90%",
    end: "bottom 70%",
    scrub: 2
  },
...
window.addEventListener("resize", function () {
  const img = new Image();
        img.src = files(0); // Use the first image to determine the size
        img.onload = () => {
